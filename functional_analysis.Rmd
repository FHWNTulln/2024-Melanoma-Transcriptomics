...
```{r MCM1GvsHEM_go_bp_dotplot, eval=MCM1GvsHEM.go_bp.plot, fig.asp=1.25}
...
cnetplot(gseGO.1GvsHEM.BP, showCategory = 5, color.params = list(foldChange = gene_list.1GvsHEM),
...
emapplot(gseGO.1GvsHEM.BP.pwts, force = 1.5,
...
cnetplot(gseGO.1GvsHEM.CC, showCategory = 5, color.params = list(foldChange = gene_list.1GvsHEM),
         cex.params = list(category_label = 0.6, gene_label = 0.4)) +
  scale_color_gradient2(low = "blue", mid = "white", high = "red", limits = c(-2, 2), name = "Fold Change", oob = scales::squish)
...
emapplot(gseGO.1GvsHEM.CC.pwts, force = 1.5,
         cex.params = list(category_label = 0.7)) +
  scale_fill_gradient(low = "red", high = "white", limits = c(0, 0.05), name = "adj. p-value")
```
...
cnetplot(gseGO.1GvsHEM.MF, showCategory = 5, color.params = list(foldChange = gene_list.1GvsHEM),
         cex.params = list(category_label = 0.6, gene_label = 0.4)) +
  scale_color_gradient2(low = "blue", mid = "white", high = "red", limits = c(-2, 2), name = "Fold Change", oob = scales::squish)
...
emapplot(gseGO.1GvsHEM.MF.pwts, force = 1.5,
         cex.params = list(category_label = 0.7)) +
  scale_fill_gradient(low = "red", high = "white", limits = c(0, 0.05), name = "adj. p-value")
```
...
cnetplot(gseKEGG.1GvsHEM, showCategory = 5, color.params = list(foldChange = gene_list.1GvsHEM.entrez),
         cex.params = list(category_label = 0.6, gene_label = 0.4)) +
  scale_color_gradient2(low = "blue", mid = "white", high = "red", limits = c(-2, 2), name = "Fold Change", oob = scales::squish)
...
emapplot(gseKEGG.1GvsHEM.pwts, force = 1.5,
...
cnetplot(gseDO.1GvsHEM, showCategory = 5, color.params = list(foldChange = gene_list.1GvsHEM.entrez),
         cex.params = list(category_label = 0.6, gene_label = 0.4)) +
  scale_color_gradient2(low = "blue", mid = "white", high = "red", limits = c(-2, 2), name = "Fold Change", oob = scales::squish)
...
emapplot(gseDO.1GvsHEM.pwts, force = 1.5,
         cex.params = list(category_label = 0.7)) +
  scale_fill_gradient(low = "red", high = "white", limits = c(0, 0.05), name = "adj. p-value")
...
cnetplot(gseGO.DLNvsHEM.BP, showCategory = 5, color.params = list(foldChange = gene_list.DLNvsHEM),
         cex.params = list(category_label = 0.6, gene_label = 0.4)) +
  scale_color_gradient2(low = "blue", mid = "white", high = "red", limits = c(-2, 2), name = "Fold Change", oob = scales::squish)
...
emapplot(gseGO.DLNvsHEM.BP.pwts, force = 1.5,
         cex.params = list(category_label = 0.7)) +
  scale_fill_gradient(low = "red", high = "white", limits = c(0, 0.05), name = "adj. p-value")
```
...
cnetplot(gseGO.DLNvsHEM.CC, showCategory = 5, color.params = list(foldChange = gene_list.DLNvsHEM),
         cex.params = list(category_label = 0.6, gene_label = 0.4)) +
  scale_color_gradient2(low = "blue", mid = "white", high = "red", limits = c(-2, 2), name = "Fold Change", oob = scales::squish)
...
emapplot(gseGO.DLNvsHEM.CC.pwts, force = 1.5,
         cex.params = list(category_label = 0.7)) +
  scale_fill_gradient(low = "red", high = "white", limits = c(0, 0.05), name = "adj. p-value")
```
...
cnetplot(gseGO.DLNvsHEM.MF, showCategory = 5, color.params = list(foldChange = gene_list.DLNvsHEM),
         cex.params = list(category_label = 0.6, gene_label = 0.4)) +
  scale_color_gradient2(low = "blue", mid = "white", high = "red", limits = c(-2, 2), name = "Fold Change", oob = scales::squish)
...
emapplot(gseGO.DLNvsHEM.MF.pwts, force = 1.5,
         cex.params = list(category_label = 0.7)) +
  scale_fill_gradient(low = "red", high = "white", limits = c(0, 0.05), name = "adj. p-value")
```
...
cnetplot(gseKEGG.DLNvsHEM, showCategory = 5, color.params = list(foldChange = gene_list.DLNvsHEM.entrez),
         cex.params = list(category_label = 0.6, gene_label = 0.4)) +
  scale_color_gradient2(low = "blue", mid = "white", high = "red", limits = c(-2, 2), name = "Fold Change", oob = scales::squish)
...
emapplot(gseKEGG.DLNvsHEM.pwts, force = 1.5,
         cex.params = list(category_label = 0.8)) +
  scale_fill_gradient(low = "red", high = "white", limits = c(0, 0.05), name = "adj. p-value")
...
cnetplot(gseDO.DLNvsHEM, showCategory = 5, color.params = list(foldChange = gene_list.DLNvsHEM.entrez),
         cex.params = list(category_label = 0.6, gene_label = 0.4)) +
  scale_color_gradient2(low = "blue", mid = "white", high = "red", limits = c(-2, 2), name = "Fold Change", oob = scales::squish)
...
emapplot(gseDO.DLNvsHEM.pwts, force = 1.5,
         cex.params = list(category_label = 0.7)) +
  scale_fill_gradient(low = "red", high = "white", limits = c(0, 0.05), name = "adj. p-value")
...
cnetplot(gseGO.DLNvs1G.BP, showCategory = 5, color.params = list(foldChange = gene_list.DLNvs1G),
         cex.params = list(category_label = 0.6, gene_label = 0.4)) +
  scale_color_gradient2(low = "blue", mid = "white", high = "red", limits = c(-2, 2), name = "Fold Change", oob = scales::squish)
...
emapplot(gseGO.DLNvs1G.BP.pwts, force = 1.5,
         cex.params = list(category_label = 0.7)) +
  scale_fill_gradient(low = "red", high = "white", limits = c(0, 0.05), name = "adj. p-value")
```
...
cnetplot(gseGO.DLNvs1G.CC, showCategory = 5, color.params = list(foldChange = gene_list.DLNvs1G),
         cex.params = list(category_label = 0.6, gene_label = 0.4)) +
  scale_color_gradient2(low = "blue", mid = "white", high = "red", limits = c(-2, 2), name = "Fold Change", oob = scales::squish)
...
emapplot(gseGO.DLNvs1G.CC.pwts, force = 1.5,
         cex.params = list(category_label = 0.7)) +
  scale_fill_gradient(low = "red", high = "white", limits = c(0, 0.05), name = "adj. p-value")
```
...
cnetplot(gseGO.DLNvs1G.MF, showCategory = 5, color.params = list(foldChange = gene_list.DLNvs1G),
         cex.params = list(category_label = 0.6, gene_label = 0.4)) +
  scale_color_gradient2(low = "blue", mid = "white", high = "red", limits = c(-2, 2), name = "Fold Change", oob = scales::squish)
...
emapplot(gseGO.DLNvs1G.MF.pwts, force = 1.5,
         cex.params = list(category_label = 0.7)) +
  scale_fill_gradient(low = "red", high = "white", limits = c(0, 0.05), name = "adj. p-value")
```
...
cnetplot(gseKEGG.DLNvs1G, showCategory = 5, color.params = list(foldChange = gene_list.DLNvs1G.entrez),
         cex.params = list(category_label = 0.6, gene_label = 0.4)) +
  scale_color_gradient2(low = "blue", mid = "white", high = "red", limits = c(-2, 2), name = "Fold Change", oob = scales::squish)
...
emapplot(gseKEGG.DLNvs1G.pwts, force = 1.5,
         cex.params = list(category_label = 0.8)) +
  scale_fill_gradient(low = "red", high = "white", limits = c(0, 0.05), name = "adj. p-value")
...
cnetplot(gseDO.DLNvs1G, showCategory = 5, color.params = list(foldChange = gene_list.DLNvs1G.entrez),
         cex.params = list(category_label = 0.6, gene_label = 0.4)) +
  scale_color_gradient2(low = "blue", mid = "white", high = "red", limits = c(-2, 2), name = "Fold Change", oob = scales::squish)
...
emapplot(gseDO.DLNvs1G.pwts, force = 1.5,
         cex.params = list(category_label = 0.7)) +
  scale_fill_gradient(low = "red", high = "white", limits = c(0, 0.05), name = "adj. p-value")
...
cnetplot(gseGO.DLN3DvsDLN.BP, showCategory = 5, color.params = list(foldChange = gene_list.DLN3DvsDLN),
         cex.params = list(category_label = 0.6, gene_label = 0.4)) +
  scale_color_gradient2(low = "blue", mid = "white", high = "red", limits = c(-2, 2), name = "Fold Change", oob = scales::squish)
...
emapplot(gseGO.DLN3DvsDLN.BP.pwts, force = 1.5,
         cex.params = list(category_label = 0.7)) +
  scale_fill_gradient(low = "red", high = "white", limits = c(0, 0.05), name = "adj. p-value")
```
...
cnetplot(gseGO.DLN3DvsDLN.CC, showCategory = 5, color.params = list(foldChange = gene_list.DLN3DvsDLN),
         cex.params = list(category_label = 0.6, gene_label = 0.4)) +
  scale_color_gradient2(low = "blue", mid = "white", high = "red", limits = c(-2, 2), name = "Fold Change", oob = scales::squish)
...
emapplot(gseGO.DLN3DvsDLN.CC.pwts, force = 1.5,
         cex.params = list(category_label = 0.7)) +
  scale_fill_gradient(low = "red", high = "white", limits = c(0, 0.05), name = "adj. p-value")
```
...
cnetplot(gseGO.DLN3DvsDLN.MF, showCategory = 5, color.params = list(foldChange = gene_list.DLN3DvsDLN),
         cex.params = list(category_label = 0.6, gene_label = 0.4)) +
  scale_color_gradient2(low = "blue", mid = "white", high = "red", limits = c(-2, 2), name = "Fold Change", oob = scales::squish)
...
emapplot(gseGO.DLN3DvsDLN.MF.pwts, force = 1.5,
         cex.params = list(category_label = 0.7)) +
  scale_fill_gradient(low = "red", high = "white", limits = c(0, 0.05), name = "adj. p-value")
```
...
cnetplot(gseKEGG.DLN3DvsDLN, showCategory = 5, color.params = list(foldChange = gene_list.DLN3DvsDLN.entrez),
         cex.params = list(category_label = 0.6, gene_label = 0.4)) +
  scale_color_gradient2(low = "blue", mid = "white", high = "red", limits = c(-2, 2), name = "Fold Change", oob = scales::squish)
...
emapplot(gseKEGG.DLN3DvsDLN.pwts, force = 1.5,
         cex.params = list(category_label = 0.8)) +
  scale_fill_gradient(low = "red", high = "white", limits = c(0, 0.05), name = "adj. p-value")
...
cnetplot(gseDO.DLN3DvsDLN, showCategory = 5, color.params = list(foldChange = gene_list.DLN3DvsDLN.entrez),
         cex.params = list(category_label = 0.6, gene_label = 0.4)) +
  scale_color_gradient2(low = "blue", mid = "white", high = "red", limits = c(-2, 2), name = "Fold Change", oob = scales::squish)
...
emapplot(gseDO.DLN3DvsDLN.pwts, force = 1.5,
         cex.params = list(category_label = 0.7)) +
  scale_fill_gradient(low = "red", high = "white", limits = c(0, 0.05), name = "adj. p-value")
